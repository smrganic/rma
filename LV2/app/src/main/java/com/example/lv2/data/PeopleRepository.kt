...
object PeopleRepository {
    ...
    fun insertPerson(person: InspiringPerson) = people.add(person)
    fun editPerson(person: InspiringPerson, editedPerson: InspiringPerson) {
        people.add(people.indexOf(person), editedPerson)
        people.remove(person)
    }
    fun removePerson(person: InspiringPerson) = people.remove(person)
}